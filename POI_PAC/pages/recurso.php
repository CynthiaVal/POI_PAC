                            ...
                            <?php
                                   ...
                                   // $conexion->next_result();
                                    ...
                                    for ($i=0;$i<count($actividad);$i++)
                                    {
                                        ...
                                        echo "
                                        <li><a href='ac_recurso.php?act=".$act."'> <h5>/ ".utf8_encode($actividad[$i][0])."</a></li>
                                        ";   
                                    }                                                                 
                            ?>
                              <?php
                                   ...
                                   // $conexion->next_result();
                                    ...
                                    for ($i=0;$i<count($tarea);$i++)
                                    {
                                        ...
                                        echo "
                                        <li class=''><a href='tarea_re.php?act=".$act."&tar=".$tar."' ><h5>/ ".utf8_encode($tarea[$i][0])."</a></li>
                                        ";   
                                    }                                                                 
                            ?>
                ...
                <div class="row">
                        <div class="panel panel-primary">
                            ...
                            <div class="row">
                                ...
                                <button type="button" class="btn btn-primary" ><span class="glyphicon glyphicon-arrow-left"></span> Anterior</button>
                                <button type="submit" class="btn btn-primary"> Siguiente <span class="glyphicon glyphicon-arrow-right"></span></button></p>
