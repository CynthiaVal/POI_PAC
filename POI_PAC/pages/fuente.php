...
<head>
   ...
   <title>Recursos Ordinarios</title>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            Fuente de Financiamiento<span class="fa arrow"></span></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">/ Fuente de Financiamiento</li>
                        </ol>
                       </h3>
                                      ...
                                      <table class="responsive table table-striped table-bordered table-hover">
                                            ...
                                            $result = $conexion->query($query);
                                                ...
                                                for ($i=0;$i<count($recurso);$i++)
                                                {
                                                    echo "
                                                    <tr>
                                                        <td><a href='recurso1.php?f1=".$f1."&rec=".$recurso[$i][0]."&posicion=".$i."'>".utf8_encode($recurso[$i][1])." </a> </td>
                                                        <td>".$recurso[$i][2]."</td>
                                                        <td>".$recurso[$i][3]."</td>
                                                        <td>".$recurso[$i][4]."</td>
