                ...
                <div class="row">
                        <div class="panel panel-primary">
                            ...
                            <div class="row">
                                ...
                                <button type="submit" class="btn btn-primary"><a onclick="window.location = 'recurso1.php'" target="_new" href=" <?php echo "recurso1.php?f1=$f1&posicion=$posicion&rec=".$recursos[$posicion].""; ?> " > Anterior</a><span class="glyphicon glyphicon-arrow-right"></span></button></p>
