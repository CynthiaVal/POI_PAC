                            ...
                            <?php
                                   ...
                                   // $conexion->next_result();
                                    ...
                                    for ($i=0;$i<count($actividad);$i++)
                                    {
                                        ...
                                        echo "
                                        <li><a href='ac_recurso.php?act=".$act."'> <h5>/ ".utf8_encode($actividad[$i][0])."</h5></a></li>
                                        ";   
                                    }                                                                 
                                ?>
                                          ...
                                          <?php
                                           //include("conexion.php");
                                                ...
                                                for ($i=0;$i<count($recurso);$i++)
                                                {
                                                    echo "
                                                    <tr>
                                                        <td><a href='recurso.php?act=".$act."&tar=".$tar."&rec=".$recurso[$i][0]."'>".utf8_encode($recurso[$i][1])." </a> </td>
                                                        <td>".$recurso[$i][2]."</td>
                                                        <td>".$recurso[$i][3]."</td>
                                                        <td>".$recurso[$i][4]."</td>
