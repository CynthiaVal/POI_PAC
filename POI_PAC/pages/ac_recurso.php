             ...
             <ul class="nav navbar-nav navbar-center">
                    ...
                    <li class="active">
                      ...
                      <ul class="dropdown-menu">
                        <li class="active"><a  href="index.ph">POI 2014 </a></li>
                                   ...
                                   // $conexion->next_result();
                                    ...
                                    for ($i=0;$i<count($actividad);$i++)
                                    {
                                        echo
                                            ...
                                            "<h3>".utf8_encode($actividad[$i][0])."</h3>";    
                                    }                                                                                    
                                ?>
                                                                ...
                                                                for ($i=0;$i<count($tarea);$i++)
                                                                  {
                                                                        ...
                                                                        if($i==0){
                                                                            ...
                                                                            "
                                                                          <li>
                                                                              <a href='tarea_re.php?act=".$act."&tar=".$tarea[$i][0]."'>".utf8_encode($tarea[$i][1])."</a>
                                                                          </li>";
