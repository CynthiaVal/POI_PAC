                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="  container">
                            ...
                            <div class="row">
                                ...
                                <button type="submit" class="btn btn-primary"><a onclick="window.location = 'proyecto.php'" target="_new" href=" <?php echo "proyecto.php?accion=$accion&posicion=$posicion&pro=".$proyectos[$posicion]."&res=$res"; ?> " >SIGUIENTE </a> <span class="glyphicon glyphicon-arrow-right"></span></button></p>
