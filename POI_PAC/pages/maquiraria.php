                    ...
                    <div class="panel panel-primary">
                         <div class="row text-center">
                            <div class="col-lg-10 col-lg-offset-1">
                                <h3>Maquinarias Equipo Y mobiliario</h3>
                                <hr class="small">       
                            </div>
                        </div>
                        <div class="  container">
                            <div class="row " >
                                ...
                                <div class="col-lg-10 ">
                                      <table class="responsive table table-striped table-bordered table-hover">
                                            ...
                                            $recurso=array();
                                            $f1=38;
                                            $query="call ver_recurso_por_clasificador('2.6.3')";
                                            ...
                                            $result = $conexion->query($query);
                                                ...
                                                for ($i=0;$i<count($recurso);$i++)
                                                {
                                                    echo "
                                                    <tr>
                                                        <td><a href='recurso1.php?f1=".$f1."&posicion=".$i."&rec=".$recurso[$i][0]."'><h6>".utf8_encode($recurso[$i][3])."</h6> </a> </td>
                                                        <td>".$recurso[$i][6]."</td>
                                                        <td>".$recurso[$i][7]."</td>
                                                        <td>".$recurso[$i][8]."</td>
