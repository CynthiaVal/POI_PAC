                                    ...
                                    <div class="tab-pane fade in active" id="Itri">
                                        ...
                                        <table class="responsive table table-striped table-bordered table-hover">
                                            ...
                                            <?php
                                                        ...
                                                        $recurso=array();
                                                        $f1=39;
                                                        $query = "call ver_recurso_por_trimestre('1')";
                                                        $result = $conexion->query($query);
                                                        while($row = mysqli_fetch_row($result))
                                                        {
                                                            $recurso[] = $row;
                                                        ...
                                                        {                                                            
                                                                ...
                                                                <tr>
                                                                <td>
                                                                     <a href='recurso1.php?f1=".$f1."&accion=trimestre&rec=".$recurso[$i][0]."&posicion=".$i."'><h6>".utf8_encode($recurso[$i][1])."</h6></a>
                                                                </td>
                                        ...
                                        <h3>Programación II Trimestre:</h3>
                                            <table class="responsive table table-striped table-bordered table-hover">
                                                ...
                                                <?php
                                                        ...
                                                        $recurso=array();
                                                        $f1=40;
                                                        $query = "call ver_recurso_por_trimestre('2')";
                                                        $result = $conexion->query($query);
                                                        while($row = mysqli_fetch_row($result))
                                                        {
                                                            $recurso[] = $row;
                                            ...
                                            <table class="responsive table table-striped table-bordered table-hover">
                                                <tr class="info">
                                                   ...
                                                   <?php
                                                        ...
                                                        $recurso=array();
                                                        $f1=41;
                                                        $query = "call ver_recurso_por_trimestre('3')";
                                                        $result = $conexion->query($query);
                                                        while($row = mysqli_fetch_row($result))
                                                        {
                                                            $recurso[] = $row;
                                                ...
                                                <tr class="info">
                                                    ...
                                                    <th>Evaluación</th>
                                                     ...
                                                     <?php
                                                        ...
                                                        $recurso=array();
                                                        $f1=42;
                                                        $query = "call ver_recurso_por_trimestre('4')";
                                                        $result = $conexion->query($query);
                                                        while($row = mysqli_fetch_row($result))
                                                        {
                                                            $recurso[] = $row;
